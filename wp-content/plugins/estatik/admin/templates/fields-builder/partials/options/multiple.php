...
echo Es_Html_Helper::render_settings_field(__( 'Multiple', 'es-plugin' ) . ' <i class="fa fa-info-circle js-es__available-tooltipster--rets" aria-hidden="true"></i>', 'fbuilder[options][multiple]', 'checkbox', array(
